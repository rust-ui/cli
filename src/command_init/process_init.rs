...
use crate::constants::{
    file_names::{
        COMPONENTS_JSON, PACKAGE_JSON, STYLE_SLASH_TAILWIND_CSS, TAILWIND_CONFIG_JS
    },
    others::SPINNER_UPDATE_DURATION,
    paths::RELATIVE_PATH_PROJECT_DIR,
    templates_init::{TEMPLATE_COMPONENTS_JSON, TEMPLATE_GLOBAL_CSS, TEMPLATE_PACKAGE_JSON, TEMPLATE_TAILWIND_CONFIG},
};
